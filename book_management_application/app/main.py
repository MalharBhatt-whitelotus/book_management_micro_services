...
from book_management_application.app.routers.media_service_routes import media_routes
...
async def lifespan(app : FastAPI):
    ...
    manager.start_service("file","file_services.app.main",8004, settings.FILE_SERVICE_DIR)
    manager.start_service("media","media_services.app.main",8005, settings.MEDIA_SERVICE_DIR)
